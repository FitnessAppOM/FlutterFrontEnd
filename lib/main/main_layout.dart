...
import '../TaqaUI/components/taqa_play_update_banner.dart';
...
class _MainLayoutState extends State<MainLayout> with WidgetsBindingObserver {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Column(
        ...
        children: [
          ...
          const TaqaPlayUpdateBanner(),
          const TaqaIosUpdateBanner(),
  ...
  Future<void> _openCoach({bool autoOpen = false}) async {
    ...
    final isAdmin = await AccountStorage.isAdmin();
    ...
    final canUseCoachTools = AccountType.canUseCoachTools(
      hasActiveCoachMembership: hasActiveCoachMembership,
