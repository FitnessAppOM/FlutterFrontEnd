...
/// A prominent store-backed introductory offer shown near checkout.
class TaqaSubscriptionOfferBanner extends StatelessWidget {
  const TaqaSubscriptionOfferBanner({
    super.key,
    required this.title,
